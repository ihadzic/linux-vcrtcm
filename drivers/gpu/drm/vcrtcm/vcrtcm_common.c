...
{
	switch (mode) {
	case VCRTCM_XFERMODE_UNSPECIFIED:
		return "unspecified";
	case VCRTCM_PEER_PULL:
		return "peer-pull";
	case VCRTCM_PEER_PUSH:
		return "peer-push";
	case VCRTCM_PUSH_PULL:
		return "push-pull";
	default:
		return "invalid xfer_mode";
	}
}
EXPORT_SYMBOL(vcrtcm_xfer_mode_string);
